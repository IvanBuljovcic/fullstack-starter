...
export const Controlled: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Interactive example showing a controlled radio button with state management.',
      },
    },
  },
};
...
export const MultipleCheckboxes: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Example showing multiple radio buttons for selecting notification preferences.',
      },
    },
  },
};
