...
export const Controlled: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "Interactive example showing a controlled checkbox with state management.",
			},
		},
	},
};
...
export const MultipleCheckboxes: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "Example showing multiple checkboxes for selecting notification preferences.",
			},
		},
	},
};
