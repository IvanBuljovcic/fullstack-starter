...
describe('SelectionInput', () => {
  ...
  describe('Required Field', () => {
    it('should render required indicator when required prop is true', () => {
      render(
        <SelectionInput label="Accept terms" required variant="checkbox" />
      );
  ...
  describe('User Interactions - Radio', () => {
    it('should handle onChange event for radio', async () => {
      ...
      render(
        <SelectionInput name="test" onChange={handleChange} variant="radio" />
      );
      const input = screen.getByRole('radio');
  ...
  describe('Common Interactions', () => {
    ...
    it('should not toggle when disabled', async () => {
      ...
      render(
        <SelectionInput disabled onChange={handleChange} variant="checkbox" />
      );
      const input = screen.getByRole('checkbox');
  ...
  describe('Accessibility', () => {
    ...
    it('should have aria-describedby pointing to helper text when provided', () => {
      ...
      expect(screen.getByText('This is required')).toHaveAttribute(
        'id',
        helperId
      );
    });
  ...
  describe('Custom Props', () => {
    ...
    it('should accept name attribute', () => {
      render(
        <SelectionInput label="Accept terms" name="terms" variant="checkbox" />
      );
      const input = screen.getByLabelText('Accept terms');
    ...
    it('should accept value attribute', () => {
      render(
        <SelectionInput label="Option A" value="optionA" variant="checkbox" />
      );
  ...
  describe('Controlled Component', () => {
    ...
    it('should respect controlled checked value', () => {
      ...
      rerender(
        <SelectionInput checked onChange={() => {}} variant="checkbox" />
      );
      expect(input).toBeChecked();
    });
  });
