...
export const WithValidation: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Interactive example showing controlled select with validation on blur.',
      },
    },
  },
};
...
export const FormExample: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Complete form example showing multiple Select components working together with validation.',
      },
    },
  },
};
