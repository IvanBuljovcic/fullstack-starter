...
describe('SmartErrorBoundary', () => {
  ...
  describe('Basic Error Catching', () => {
    ...
    it('should catch and display errors', () => {
      ...
      expect(
        screen.getByText(/Something went wrong in TestComponent/)
      ).toBeInTheDocument();
  ...
  describe('Custom Fallback Component', () => {
    it('should render custom fallback component', () => {
      const CustomFallback: ComponentType<CustomErrorFallbackProps> = ({
        error,
        context,
      }) => (
        <div>
    ...
    it('should pass all required props to custom fallback', () => {
      const CustomFallback: ComponentType<CustomErrorFallbackProps> = (
        ...
        <div>
          ...
          <span data-testid="enable-nav">
            {props.enableNavigation.toString()}
          </span>
        </div>
      );
  ...
  describe('Custom className', () => {
    it('should apply custom className to wrapper', () => {
      ...
      expect(
        container.querySelector('.custom-error-class')
      ).toBeInTheDocument();
    });
  });
  ...
  describe('Error Context Display', () => {
    it('should display the context in error message', () => {
      ...
      expect(
        screen.getByText(/Something went wrong in UserProfile/)
      ).toBeInTheDocument();
    });
    ...
    it('should handle different context names', () => {
      ...
      contexts.forEach((context) => {
        ...
        expect(
          screen.getByText(new RegExp(`Something went wrong in ${context}`))
        ).toBeInTheDocument();
        unmount();
      });
    });
  ...
  describe('Edge Cases', () => {
    ...
    it.skip('should maintain state across multiple retry attempts', async () => {
      ...
      await screen.findByRole(
        'button',
        { name: /Try Again \(4 attempts left\)/i },
        { timeout: 3000 }
      );
