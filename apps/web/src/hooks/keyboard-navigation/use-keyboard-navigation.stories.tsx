...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Custom hooks for keyboard navigation, focus management, and grid navigation patterns.',
      },
    },
  },
  tags: ['autodocs'],
  ...
  return (
    ...
    >
      ...
      <p style={{ color: '#666', fontSize: '0.875rem' }}>
        Press Arrow keys, Enter, or Escape
      </p>
      <div
        style={{
          marginTop: '1rem',
    ...
    >
      ...
      >
        ...
        <p style={{ marginBottom: '1rem', color: '#666' }}>
          Focus is trapped inside this modal. Press Tab to cycle through
...
export const FocusTrap = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story:
          'Modal with focus trapping. Tab cycles through buttons, Escape closes and restores focus.',
      },
    },
  },
} satisfies StoryObj<typeof meta>;
          ...
          {options.map((option) => (
            <button
              ...
              style={{
                ...
                border: 'none',
                backgroundColor:
                  selected === option ? '#eff6ff' : 'transparent',
                cursor: 'pointer',
              }}
              type="button"
            >
        ...
        {products.map((product, index) => (
          <li
            ...
            style={{
              padding: '1.5rem',
              border: `2px solid ${
                selected === product.id ? '#3b82f6' : '#e5e7eb'
              }`,
              borderRadius: '8px',
              textAlign: 'center',
              cursor: 'pointer',
...
export const Grid = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          '2D grid navigation using arrow keys. Perfect for product grids or image galleries.',
      },
    },
  },
} satisfies StoryObj<typeof meta>;
  ...
  return (
    <div style={{ minWidth: '400px' }}>
          ...
          <button
            ...
            style={{
              ...
              borderBottom: `2px solid ${
                activeTab === index ? '#3b82f6' : 'transparent'
              }`,
      ...
      <div role="tabpanel" style={{ padding: '1rem' }}>
        ...
        <p style={{ color: '#666' }}>
          This is the content for {tabs[activeTab].toLowerCase()}.
        </p>
      </div>
