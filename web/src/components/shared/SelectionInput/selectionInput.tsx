...
type BaseSelectionInputProps = Omit<ComponentPropsWithoutRef<"input">, "type" | "size"> & {
	label?: string;
	error?: string;
	helperText?: string;
	size?: "sm" | "md" | "lg";
...
export const SelectionInput = forwardRef<HTMLInputElement, SelectionInputProps>(
	({ variant, label, error, helperText, size = "md", className, id, disabled: isDisabled, ...props }, ref) => {
